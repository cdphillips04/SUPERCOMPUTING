...
do 
	...
	bbmap.sh -Xmx32g ref=${DOG_DIR}/dog_reference_genome.fna in1=${FWDOUT} in2=${REVOUT} out=${OUTPUT_DIR}/${f}.sam minid=0.95 
	samtools view -F 4 ${OUTPUT_DIR}/${f}.sam > ${OUTPUT_DIR}/${f}_dog-matches.sam
done
